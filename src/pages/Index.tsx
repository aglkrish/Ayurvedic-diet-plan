...
const AyurvedicDietSystem = () => {
  ...
  const PatientManagement = () => {
    ...
    const [formData, setFormData] = useState({
      ...
      mealFreq: '', bowelMov: '', waterIntake: '', medicalHistory: ''
    });

    const handleSubmit = (e) => {
      e.preventDefault();
      addPatient(formData);
      setFormData({ name: '', age: '', gender: '', dosha: '', dietType: '', mealFreq: '', bowelMov: '', waterIntake: '', medicalHistory: '' });
      setShowForm(false);
    };
          ...
          <div className="bg-card p-6 rounded-lg shadow-md border border-border">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <textarea
                ...
                className="p-2 border border-input rounded md:col-span-2 bg-background text-foreground"
                rows={3}
              />
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-green-50">
      <div className="bg-gradient-to-r from-primary to-secondary text-white p-6 shadow-lg">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-orange-100 mt-2">Holistic Nutrition Planning with Ayurvedic Principles</p>
        </div>
      </div>
...
export default AyurvedicDietSystem;
